# import os
# os.environ["OPENCV_VIDEOIO_MSMF_ENABLE_HW_TRANSFORMS"] = "0" # 웹캠실행시 오래걸리는 컴퓨터에선 주석 해제
import cv2
...
body_image = cv2.imread('body.png', cv2.IMREAD_UNCHANGED)
    ...
    while cap.isOpened():
        ...
        try:
            ...
            if game_start_event == False:
                ...
                if get_distance(righthand, lefthand) < 10 and abs(leftz-rightz) < 20 and ( w//2-150 < nose[0] < w//2+150 and 10 < nose[1] < h//2+20):
            ...
            if game_start_event == True and time_remaining > 0:
                ...
                if (rx0-50 < righthand[0] < rx0+50 and ry0-50 < righthand[1] < ry0+50) or (rx0-50 < lefthand[0] < rx0+50 and ry0-50 < lefthand[1] < ry0+50) or (rx0-50 < rightfoot[0] < rx0+50 and ry0-50 < rightfoot[1] < ry0+50) or (rx0-50 < leftfoot[0] < rx0+50 and ry0-50 < leftfoot[1] < ry0+50) :
                ...
                if (rx1-50 < righthand[0] < rx1+50 and ry1-50 < righthand[1] < ry1+50) or (rx1-50 < lefthand[0] < rx1+50 and ry1-50 < lefthand[1] < ry1+50) or (rx1-50 < rightfoot[0] < rx1+50 and ry1-50 < rightfoot[1] < ry1+50) or (rx1-50 < leftfoot[0] < rx1+50 and ry1-50 < leftfoot[1] < ry1+50) :
